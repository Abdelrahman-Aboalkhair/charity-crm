...
export const api = createApi({
  ...
  endpoints: (builder) => ({
    ...
    updateDonor: builder.mutation<Donor, { id: string; data: Partial<Donor> }>({
      ...
      invalidatesTags: (result, error, { id }) => [{ type: 'Donor', id }, 'Donor']
    }),
    ...
    updateDonation: builder.mutation<Donation, { id: string; data: Partial<Donation> }>({
      query: ({ id, data }) => ({
        url: `donations/${id}`,
        method: 'PUT',
        body: data
    ...
    updateCall: builder.mutation<Call, { id: string; data: Partial<Call> }>({
      ...
      invalidatesTags: (result, error, { id }) => [{ type: 'Call', id }, 'Call']
    }),
    ...
    updateReservation: builder.mutation<Reservation, { id: string; data: Partial<Reservation> }>({
      query: ({ id, data }) => ({
        url: `reservations/${id}`,
        method: 'PUT',
        body: data
